// WBF (Dünya Tavla Federasyonu) Uluslararası Turnuva Kural ve Prosedürleri — Türkçe.
// Kaynak: WBF Birleştirilmiş Edisyon 1996/05/18. Referans/eğitim amaçlı; SEO içeriği (/turnuva-kurallari).
// İçerik BİREBİR korunur; yalnız yapısal (bölüm/başlık/paragraf) modele çevrilmiştir.

export interface RuleSection {
  num: string // '1.1'
  title: string
  body: string[] // paragraflar (madde listeleri de paragraf olarak)
}
...
export const TOURNAMENT_RULES: RuleGroup[] = [
  {
    num: '1.0',
    title: 'Özellikler',
    sections: [
      ...
      },
      {
        num: '1.3',
        title: 'Kapsam',
        body: ['Aksi belirtilmedikçe, genel kabul gören tavla kuralları geçerlidir.'],
      },
      {
        num: '1.4',
        title: 'Ekip',
  ...
  {
    num: '4.0',
    title: 'Oyunun Oynanışı ve Kural Dışı Hareketler',
    sections: [
      {
        num: '4.1',
        title: 'Rastgele Atışlar',
        body: [
      ...
      {
        num: '4.7',
        title: 'Başlangıç Dizilişinde Hata',
        body: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        num: '5.4',
        title: 'Vido (Oyunu Katlama) Önerme',
        body: [
      ...
      {
        num: '5.7',
        title: 'Küpsüz Oyun (Crawford Oyunu)',
        body: [
...
// Edisyon bilgisi (altbilgi).
export const RULE_EDITION =
  'WBF Birleştirilmiş Edisyon 1996/05/18 (ISO — Uluslararası Standartlar Organizasyonu — tarih formatı). Evvelki edisyonlar: 1. Edisyon 1976, 2. Edisyon 1979, 3. Edisyon 1985, 4. Edisyon Temmuz 1988.'
