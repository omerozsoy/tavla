...
const FAQ_VISUALS: Record<string, FaqVisual | FaqVisual[]> = {
  ...
  nackgammon: { kind: 'board', state: faqBoard({ 0: 2, 5: 4, 7: 3, 11: 4, 12: -4, 16: -3, 18: -4, 23: -2 }), caption: 'Nackgammon başlangıç düzeni, TavlaTV tahtasıyla yeniden oluşturuldu.' },
  'hyper-backgammon': { kind: 'board', state: faqBoard({ 0: 1, 23: -1 }, { white: 2, black: 2 }), caption: 'Hyper-backgammon’un kısa başlangıç düzeni, standart board bileşeniyle.' },
  'long-gammon': { kind: 'board', state: faqBoard({ 0: 2, 5: 5, 7: 3, 11: 5, 12: -5, 16: -3, 18: -5, 23: -2 }), caption: 'Long-gammon başlangıç konumu, TavlaTV tahtasıyla yeniden oluşturuldu.' },
  'acey-deucey': { kind: 'image', src: sourceFaqImage('faq/gif/aceydeucey.gif'), alt: 'Acey-deucey tanıtım görseli' },
  ...
  'plakoto-nasil-oynanir': { kind: 'board', state: faqBoard({ 0: 2, 5: 5, 7: 3, 11: 5, 12: -5, 16: -3, 18: -5, 23: -2 }), caption: 'Plakoto başlangıç konumu, TavlaTV tahtasıyla yeniden oluşturuldu.' },
  'fevga-nasil-oynanir': { kind: 'board', state: faqBoard({ 0: 2, 5: 5, 7: 3, 11: 5, 12: -5, 16: -3, 18: -5, 23: -2 }), caption: 'Fevga başlangıç konumu, TavlaTV tahtasıyla yeniden oluşturuldu.' },
  trictrac: { kind: 'image', src: sourceFaqImage('faq/gif/trictrac.gif'), alt: 'Trictrac görseli' },
  'rus-tavlasi': { kind: 'board', state: faqBoard({ 0: 2, 5: 5, 7: 3, 11: 5, 12: -5, 16: -3, 18: -5, 23: -2 }), caption: 'Russian backgammon başlangıç düzeni, TavlaTV tahtasıyla yeniden oluşturuldu.' },
  'snake-tavla': { kind: 'board', state: faqBoard({ 0: 2, 5: 5, 7: 3, 11: 5, 12: -5, 16: -3, 18: -5, 23: -2 }), caption: 'Snake başlangıç düzeni, TavlaTV tahtasıyla yeniden oluşturuldu.' },
