...
export default function MatchReport({
  ...
  //
  // OTORİTER KAYNAK: sunucu (.mat = birleşik game_logs -> MatFromLog -> MatSerializer) -> AYNI maç
  // (uid) DAİMA AYNI deterministik dosya. Kayıt best-effort flush edildiğinden henüz düşmemiş
  // olabilir -> kısa retry. Sunucu hâlâ veremezse (flush yarışı/erişim) SESSİZ yerel yedek
  // (buildMatXg) devreye girer -> buton ASLA boşa düşmez, "hazırlanıyor" uyarısı GÖSTERİLMEZ.
  async function exportMat() {
    ...
    // Sessiz yerel yedek: sunucu kaydı henüz hazır değil/erişilemedi (uyarı gösterme).
    const now = new Date()
